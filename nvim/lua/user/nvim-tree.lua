...
local function on_attach(bufnr)
    ...
    vim.keymap.set('n', '<Space>p', api.node.navigate.diagnostics.prev,
                   opts('Prev Diagnostic'))
    vim.keymap.set('n', '<Space>.', api.node.navigate.diagnostics.next,
                   opts('Next Diagnostic'))
    vim.keymap
        .set('n', '<Space>k', api.node.navigate.git.prev, opts('Prev Git'))
    vim.keymap
        .set('n', '<Space>j', api.node.navigate.git.next, opts('Next Git'))
    vim.keymap.set('n', 'u', api.tree.change_root_to_parent, opts('Up'))
    vim.keymap.set('n', '\'', api.node.navigate.parent_close,
                   opts('Close Directory'))
